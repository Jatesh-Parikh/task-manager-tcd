...
function Filters() {
  ...
  return (
    <div
      className="relative py-2 px-2 grid grid-cols-4 items-center gap-3
    bg-[#F9F9F9] border-white border-2 rounded-md"
    >
      <span
        ...
        style={{
          ...
          transition: "transform 300ms cubic-bezier(0.95, 0.03, 1, 1)",
        }}
      ></span>
